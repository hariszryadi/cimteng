		...
		<div class="row">
            <div class="col-sm-12">
                <ul class="portfolio-filter text-center">
                    <li><a class="btn btn-default waves-effect active" href="#" data-filter=".monograph">Monografi</a></li>
                    <li><a class="btn btn-default waves-effect" href="#" data-filter=".employee">Kepegawaian</a></li>
                    <li><a class="btn btn-default waves-effect" href="#" data-filter=".potency">Potensi</a></li>
                </ul><!--/#portfolio-filter-->
                
                <div class="portfolio-boxes">
                    <div class="each-box col-xs-12 portfolio-box monograph">
                        <div class="row">
                    ...
                    <div class="each-box col-xs-12 portfolio-box employee" hidden>
                        <div class="row">
                            <div class="col-md-12" style="padding-bottom: 18px;">
                                <div class="about-intro-text">
                                    <table class="table apt-table-wrapper" id="table-employee">
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                        ...
                                        <tbody>
                                            @php
                                                $i = 1;
                                            @endphp
                                            @foreach ($uv->employee as $item)
                                                <tr>
                                                    <td width="5%">{{ $i++ }}</td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <img src="{{ asset('storage/'.$item->avatar) }}" alt="{{ $item->name }}" class="img-avatar" style="margin: 0 auto; width: 100px !important;" data-fancybox="images">
                                                            </div>
                                                            <div class="col-sm-6">
                    ...
                    <!-- Single portfolio box box end -->
                    <div class="each-box col-xs-12 portfolio-box potency" hidden>
                        <div class="row">
                            <div class="col-md-12" style="padding-bottom: 18px;">
                                <div class="about-intro-text table-responsive">
                                    <table class="table apt-table-wrapper" id="table-potency">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>No IUMK</th>
...
<script>
    $(document).ready(function(){
        ...
        $('.portfolio-filter > li > a').on('click', function () {
            var filter = $(this).attr('data-filter').substring(1);
