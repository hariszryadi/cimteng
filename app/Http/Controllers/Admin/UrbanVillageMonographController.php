...
use App\Models\UrbanVillageMonograph;
use DataTables;

class UrbanVillageMonographController extends Controller
{
    protected $_view = 'backend.urban-village.monograph.';
    protected $_route = 'admin.urbanVillage.monograph.index';
    ...
    {
        UrbanVillageMonograph::where('id', $request->id)->update([
